...
if (!$connection) {
    ...
    $query = "SELECT prod.product_Name,outg.outgoingId,outg.productId,outg.quantity,outg.userId from stk_outgoing outg INNER JOIN stk_products prod ON outg.productId=prod.productId";
