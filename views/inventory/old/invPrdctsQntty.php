...
if (!$connection) {
    ...
    $query = "SELECT  prod.productId, prod.product_Name, sum(inv.quantity) AS quantity from stk_inventory inv INNER JOIN stk_products prod ON inv.productId=prod.productId GROUP BY inv.productId";
