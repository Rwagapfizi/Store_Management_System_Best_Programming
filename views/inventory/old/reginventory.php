...
<body>
    ...
    <div class="container reg_container">
        ...
        if (!$connection) {
            ...
            // 1. Check if product for this user already exists in inventory
            $checkQuery = "SELECT quantity FROM stk_inventory WHERE productId = '$productId' AND userId = '$userID'";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $updateQuery = "UPDATE stk_inventory SET quantity = '$newQuantity' WHERE productId = '$productId' AND userId = '$userID'";
                ...
                $insertQuery = "INSERT INTO stk_inventory(productId, quantity, userId) VALUES('$productId', '$quantity', '$userID')";
                if (mysqli_query($connection, $insertQuery)) {
                    echo "<p style='color: green;' class='reg_message'>Product ID $productId successfully added to inventory.</p>";
                } else {
